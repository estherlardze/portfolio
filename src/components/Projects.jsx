...
const Projects = () => {
  return (
    <div className='w-[80%] mx-auto my-[100px]  2xl:w-[1500px]'>
      <div className='mb-3'>
       ...
       <div className='grid grid-cols-6 gap-5'>
         {projects.map((project, index) => (
           <article key={index} className='col-span-6 sm:col-span-3 lg:col-span-2 bg-black/60 h-fit border border-yellow-500/30 shadow-lg'>
